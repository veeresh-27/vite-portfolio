...
export function Home({ showDp }: any) {
  return (
    <>
      <div className="bg-[#2D2D2D] text-white px-20 h-screen mt-[200px]">
        {showDp && (
          <div className="flex flex-col items-center mt-[-80px] gap-4">
            <img className="rounded-[40px] z-10 shadow-md" src={ProfilePic} width={240} />
            <div className="text-center w-[520px] ">
              <h2 className="text-4xl pb-2">Veeresh R M</h2>
              <p>
